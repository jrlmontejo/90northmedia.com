...
function wwboilerplate_setup() {
	...
	register_nav_menus([
		'main-menu' => __( 'Main Menu', 'wwboilerplate' ) 
	]);
}
...
function wwboilerplate_add_scripts() {
...
add_action( 'wp_enqueue_scripts', 'wwboilerplate_add_scripts' );

function wwboilerplate_add_styles() {
...
add_action( 'wp_enqueue_scripts', 'wwboilerplate_add_styles' );