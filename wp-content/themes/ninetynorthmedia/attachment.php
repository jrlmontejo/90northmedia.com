		...
		<header class="header">
			<h1 class="entry-title">
				...
				<a 
					...
					title="<?php printf( __( 'Return to %s', 'ninetynorthmedia' ), esc_html( get_the_title( $post->post_parent ), 1 ) ); ?>" 
					rev="attachment">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<section class="entry-content">
				<div class="entry-attachment">
					...
					<?php else : ?>
						<a 
							href="<?php echo wp_get_attachment_url( $post->ID ); ?>" 
							title="<?php echo esc_html( get_the_title( $post->ID ), 1 ); ?>" 
							rel="attachment">
