		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="contact_info_other contact_info_other-address">
						<i class="fa fa-map-marker fa-lg fa-fw"></i>
						<?php echo $officeInfo['address'] ?>
					</div>
					<div class="contact_info_other contact_info_other-email">
						<i class="fa fa-envelope fa-lg fa-fw"></i>
						<?php echo $officeInfo['email'] ?>
					</div>
					<div class="contact_info_other contact_info_other-phone">
						<i class="fa fa-phone fa-lg fa-fw"></i>
						<?php echo $officeInfo['phone'] ?>
					</div>
					<div class="contact_info_other contact_info_other-social">
						<div class="social_fb">
